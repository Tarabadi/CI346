...
class UpdateDialog extends React.Component {
	...
	handleSubmit(e) {
		...
		//updatedEmployee.push(this.props.employee.entity.day);
	...
	render() {
		return (
			<tr>
				...
				<td>{this.props.employee.entity.firstShift}</td>
				<td>{this.props.employee.entity.secondShift}</td>
				<td>{this.props.employee.entity.thirdShift}</td>
				<td>
